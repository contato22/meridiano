    ...
    (e.modules = {
      ...
      507: (e, r, t) => {
        ...
        let l = [
                  ...
                  children: [
                    'accounts',
                    {
                      children: [
                        ...
                        {
                          page: [
                            () => Promise.resolve().then(t.bind(t, 1995)),
                            '/home/user/meridiano/apps/web/app/(dashboard)/accounts/page.tsx',
                          ],
                        },
                      ],
                    },
          ...
          c = ['/home/user/meridiano/apps/web/app/(dashboard)/accounts/page.tsx'],
          ...
          return (0, s.jsxs)('div', {
            children: [
              ...
              (0, s.jsx)('p', {
                ...
                children:
                  'Stub — vir\xe1 com listagem real quando o repository Drizzle estiver ligado (PR-C).',
              }),
            ],
          });
        }
