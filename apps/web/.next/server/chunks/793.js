  ...
  (exports.modules = {
    ...
    1347: (e, t, r) => {
      ...
      let h = u.default.forwardRef(function (e, t) {
        ...
        let E = u.default.useContext(a.AppRouterContext),
        ...
        let k = M ? n && 'object' == typeof n && n.ref : t,
          ...
          U = u.default.useCallback(
            (e) => {
              ((w.current !== T || I.current !== S) && (N(), (w.current = T), (I.current = S)),
                A(e));
            },
            [T, S, N, A],
          ),
          q = (0, s.useMergedRef)(U, k);
        u.default.useEffect(() => {}, [T, S, R, !1 !== b, E, C]);
        let F = {
          ref: q,
          onClick(e) {
                ...
                (function (e, t, r, n, o, l, a) {
                  ...
                  ('A' === i.toUpperCase() &&
                    ...
                    u.default.startTransition(() => {
                      let e = null == a || a;
                      'beforePopState' in t
                        ? t[o ? 'replace' : 'push'](r, n, { shallow: l, scroll: e })
        ...
        return (
          ...
          M ? u.default.cloneElement(n, F) : (0, o.jsx)('a', { ...x, ...F, children: r })
        );
      });
      ('function' == typeof t.default || ('object' == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
